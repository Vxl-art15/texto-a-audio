...
st.title("Generación de Audio desde Texto")
image = Image.open('Irelia.jpg')
...
st.write('"Nuestra tierra es una de magia. Una por la que vale la pena morir." ' 
         '  '
         ' Irelia.'
        
        )
           
st.markdown(f"¿Quieres escucharlo? Copia el texto aquí:")
text = st.text_area("Escriba aquí el texto que desea escuchar")
